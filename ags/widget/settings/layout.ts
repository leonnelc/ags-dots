...
export default [
    ...
    Page("General", icons.ui.settings,
        ...
        Group("Powermenu",
            ...
            Row({ opt: pm.shutdown, title: "Shutdown action", type: "string"}),
            Row({ opt: pm.sleep, title: "Sleep action", type: "string"}),
            Row({ opt: pm.reboot, title: "Reboot action", type: "string"}),
            Row({ opt: pm.lock, title: "Lock action", type: "string"}),
            Row({ opt: pm.logout, title: "Logout action", type: "string"}),
        ),
        Group("Battery",
            Row({ opt: b.battery.enableBatteryControl, title: "Enable battery control", type: "boolean", note: "Enable low battery notifications and auto sleep "}),
            Row({ opt: b.battery.low, title: "Battery low level", type: "number", max: 100, min: 0, note: "Notifications will pop up when it's reached, set to 0 to disable."}),
            Row({ opt: b.battery.veryLow, title: "Battery very low level", type: "number", max: 100, min: 0, note: "Sleep action will be executed when it's reached, set to 0 to disable."}),
        ),
        Group("Overview",
